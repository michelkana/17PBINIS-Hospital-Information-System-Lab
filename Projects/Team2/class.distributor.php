<?php
	...
	class distributor{
		...
		function request_deny_access($id){
			$current_doctor = new doctor();
			$success = $current_doctor->deni_access($id);
			return $success;
		}
        ...
        function request_repeat($id_doc,$day,$month,$year,$r_day,$r_week,$r_month,$time_in,$time_out){
            $current_doctor = new doctor();
            $success = $current_doctor->db_repeat($id_doc,$day,$month,$year,$r_day,$r_week,$r_month,$time_in,$time_out);
			return $success;
        }
////////////////////////////////
		//PATIENT
